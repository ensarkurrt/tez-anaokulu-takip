...
import 'package:kindergarden_mobile/application_layer/features/school/classes/classes_view.dart';
import 'package:kindergarden_mobile/application_layer/features/school/gallery/gallery_view.dart';
import 'package:kindergarden_mobile/application_layer/features/school/student/students_view.dart';
    ...
    return VerticalColumnWithSpace(
      children: [
        ...
        TMButton(
            title: "Öğrenciler",
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const StudentsView()));
            }),
        TMButton(
            title: "Çıkış Yap",
