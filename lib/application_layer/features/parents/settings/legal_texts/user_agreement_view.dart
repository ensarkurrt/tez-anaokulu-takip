...
class UserAgreementView extends StatefulWidget {
  const UserAgreementView({super.key});

  @override
  State<UserAgreementView> createState() => _UserAgreementViewState();
}

class _UserAgreementViewState extends State<UserAgreementView> {
  @override
  ...
  Column TextColumn(BuildContext context) {
    return Column(
      ...
      children: [
        Text('Kullanıcı Sözleşmesi', style: context.fonts.title.copyWith(color: context.textColors.title)),
